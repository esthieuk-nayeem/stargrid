...
export default function BackupRecovery() {
    ...
    return (
        <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Backup & Recovery">
                        ...
                        <div className="col-xl-8 col-lg-7">
                            <div className="services-details__right">
                                ...
                                <div className="services-details__img-1">
                                    <Image src="/assets/images/services/services-details-img-2.jpg" alt="Image" width={850} height={400} priority />
                                </div>
