...
export default function DataProtectionPrivacy() {
    ...
    return (
        <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Data Protection & Privacy">
                        ...
                        <div className="col-xl-8 col-lg-7">
                            <div className="services-details__right">
                                ...
                                <div className="services-details__img-1">
                                    <Image src="/assets/images/services/services-details-img-4.jpg" alt="Image" width={850} height={400} priority />
                                </div>
