// Enhanced questionnaire data with scoring/mapping values for product matching
...
export const questionnaireData = [
  ...
  },
  {
    ...
    scoreMultiplier: 20 // Each point = 20% weight
  }
];
...
// Helper function to extract scoring data from answers
export const extractScoringData = (answers) => {
  ...
  Object.keys(answers).forEach(questionId => {
    ...
    // Extract scores based on question type
    if (question.type === 'single') {
      ...
      if (answer && answer.downlink && answer.uplink) {
        const downlinkOpt = question.subQuestions[0].options.find(o => o.value === answer.downlink);
        const uplinkOpt = question.subQuestions[1].options.find(o => o.value === answer.uplink);
